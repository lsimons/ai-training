...
export const AREAS: Area[] = [
	...
	{
		slug: 'customizing-agents',
		name: 'Customizing agents',
		group: 'Engineering',
		description: 'Configuring an agent for a project.',
	},
	{
		slug: 'building-agents',
		name: 'Building agents',
		group: 'Engineering',
		description: 'Building an agent from a model, a loop and tools.',
	},
];
