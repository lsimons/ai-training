...
only in your organisation's private documents. Knowledge is
...
<Choice id="what-the-model-does" objective="concepts/explains-models/explains-generation"
  ...
  options={[
    ...
    { text: 'It searched the web and summarised the results.', why: 'Search is a separate tool some products add on top. The model itself only predicts tokens; it has no built-in search.' },
...
<Choice id="name-the-failure" objective="concepts/explains-models/names-failure-modes"
  ...
  options={[
    ...
    { text: 'A tokenisation problem', why: 'Tokenisation affects things like counting letters, not knowledge of recent events.' },
  ]}>
