...
| Learn Prompting (`license-CC-BY` branch only) | CC BY 4.0              | Adapt short technique and prompt-hacking definitions with attribution in `NOTICE.md`; everything from 2023-02-16 onward (`main`, the live site) is CC BY-NC-SA and is cite-only. See [explore/12](./explore/12-learn-prompting.md).              |
