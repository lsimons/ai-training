...
| **Prompt block**  | A prompt shown to the learner, paired with a **response block** holding the recorded model response, both naming the model and the month recorded.          | chat transcript, example               |
