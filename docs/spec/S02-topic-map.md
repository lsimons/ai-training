...
| `Claude Code how it works`     | Anthropic's Claude Code documentation page "How Claude Code works" at `code.claude.com/docs/en/how-claude-code-works`                                               | Proprietary                 | What compaction keeps and may drop as facts, re-checked by `review-by`; no text adapted               |
