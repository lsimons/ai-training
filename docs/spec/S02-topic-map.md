...
| `Claude Code best practices`   | Anthropic's Claude Code documentation page "Best practices for Claude Code" at `code.claude.com/docs/en/best-practices`                                             | Proprietary                 | Plan-first, failing-test, resume, restart advice as facts, re-checked by `review-by`; no text adapted |
