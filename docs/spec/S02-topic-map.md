...
| `Claude Code memory`           | Anthropic's Claude Code documentation page "How Claude remembers your project" at `code.claude.com/docs/en/memory`                                                  | Proprietary                 | Loading, folders, note types and imports as facts, re-checked by `review-by`; no text adapted         |
...
| `AI Training AGENTS`           | This repository's agent instructions, `AGENTS.md` on GitHub, its own written practice for agents: gates, attribution, voice                                         | CC BY-SA 4.0                | Our own practice, quoted and described as the worked example                                          |
| `AI Training wave lead prompt` | This repository's wave lead prompt, `.claude/skills/wave/wave-lead-prompt.md` on GitHub, whose rules name the incident behind them                                  | CC BY-SA 4.0                | Our own practice, quoted and described as the worked example                                          |
