...
| `AI Training writing-a-lesson` | This repository's authoring guide, `docs/agents/writing-a-lesson.md` on GitHub at a fixed commit, whose rules name the incident behind them                         | CC BY-SA 4.0                | Our own practice, described in our words as the worked example                                        |
