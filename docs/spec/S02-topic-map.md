...
| `Agent Skills spec`            | The Agent Skills specification at `agentskills.io/specification`, the open format for a skill directory and its `SKILL.md` file                                     | Proprietary                 | Field names and limits as facts, re-checked by `review-by`; no text adapted                           |
