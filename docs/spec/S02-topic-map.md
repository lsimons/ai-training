...
| `Hardy 1988`                   | Hardy, "The Confused Deputy" (ACM SIGOPS Operating Systems Review 1988), on a program that spends its own authority on a caller's request                           | Copyright ACM               | The example and the term cited as facts, in our own words; no text adapted                            |
