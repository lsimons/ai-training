...
| `Claude docs <slug>` | The Claude Platform documentation page at `https://platform.claude.com/docs/en/agents-and-tools/tool-use/<slug>`, Anthropic's public API reference                  | Proprietary                 | Field names, stop reasons and message formats as facts; no text adapted         |
