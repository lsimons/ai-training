...
| `Wang 2023`                    | Wang et al., "Plan-and-Solve Prompting: Improving Zero-Shot Chain-of-Thought Reasoning by Large Language Models" (ACL 2023), a plan-first prompt                    | CC BY 4.0                   | Findings cited as facts, in our own words; no text adapted                                            |
