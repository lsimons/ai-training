...
| `Claude Code worktrees`        | Anthropic's Claude Code documentation page "Run parallel sessions with worktrees" at `code.claude.com/docs/en/worktrees`                                            | Proprietary                 | Worktree location and hook paths in a worktree as facts; no text adapted                              |
...
| `OpenTelemetry GenAI spans`    | The OpenTelemetry GenAI semantic conventions page "Semantic conventions for generative client AI spans"                                                             | Apache-2.0                  | Span names, attributes and content capture as facts; no text adapted                                  |
