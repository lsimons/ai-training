...
| `Sharma 2023`                  | Sharma et al., "Towards Understanding Sycophancy in Language Models" (2023), which measured sycophancy in deployed assistants and traced it to preference training  | CC BY 4.0                   | Cited for the finding and its cause; no text copied                                                   |
