...
| `Claude Code permissions`      | Anthropic's Claude Code documentation page "Configure permissions" at `code.claude.com/docs/en/permissions`                                                        | Proprietary                 | Rule syntax, matching and precedence as facts, re-checked by the lesson's `review-by` date; no text adapted |
