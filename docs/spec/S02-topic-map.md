...
| `Brown 2020`        | Brown et al., "Language Models are Few-Shot Learners" (2020), the paper that named few-shot prompting                                                               | arXiv preprint              | Cited for the term and the finding; no text copied                              |
