...
| `Claude Code agent loop`       | Anthropic's Claude Code documentation page "How the agent loop works" at `code.claude.com/docs/en/agent-sdk/agent-loop`                                             | Proprietary                 | Option names, defaults, result subtypes and compaction as facts, re-checked by `review-by`; no text   |
