...
| `Linux coding assistants`      | The Linux kernel's "AI Coding Assistants" guideline, on who may sign off and on the `Assisted-by` tag for AI help                                                   | GPL-2.0                     | Sign-off and attribution rules as facts, re-checked by `review-by`; no text adapted                   |
