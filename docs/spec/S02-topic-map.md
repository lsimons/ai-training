...
| `Claude Code CLI reference`    | Anthropic's Claude Code documentation page "CLI reference" at `code.claude.com/docs/en/cli-reference`                                                               | Proprietary                 | Command-line flags as facts, re-checked by `review-by`; no text adapted                               |
