...
| `Madaan 2023`                  | Madaan et al., "Self-Refine: Iterative Refinement with Self-Feedback" (arXiv 2303.17651), on one model that critiques and revises                                   | CC BY 4.0                   | Findings cited as facts, in our own words; no text adapted                                            |
