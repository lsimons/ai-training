...
| `CS50x`                        | CS50's Introduction to Computer Science, and the CS50 AI tutor that runs across it, the source of the endorsed-answers idea                                         | CC BY-NC-SA 4.0             | Ideas and vocabulary, cited; no text adapted                                                          |
