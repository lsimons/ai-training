...
| `GitHub docs <page>`           | A page of GitHub's documentation at `https://docs.github.com/en/<page>`, from the `github/docs` repository                                                          | CC BY 4.0                   | Workflow and event behavior as facts; no text adapted                                                 |
...
| `Claude Code security`         | Anthropic's Claude Code documentation page "Security" at `code.claude.com/docs/en/security`                                                                         | Proprietary                 | The working directory boundary and MCP trust advice as facts, re-checked by `review-by`               |
| `Claude Code security`         | Anthropic's Claude Code documentation page "Security" at `code.claude.com/docs/en/security`                                                                         | Proprietary                 | The Manual mode working directory boundary as a fact, re-checked by `review-by`                       |
