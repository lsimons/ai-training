...
| `Anthropic tool use` | Anthropic's tool use documentation: the overview, "Define tools" and "Strict tool use" pages                                                                        | Proprietary                 | Field names, API behavior and the description guidance as facts; no text adapted |
