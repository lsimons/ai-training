...
| S02 | [Topic map and competencies](S02-topic-map.md) | Name what the site teaches (topics and concepts, with prerequisite links), name what a learner should be able to do afterwards (competencies, objectives, behaviours), and say how the map differentiates between learners. | Draft  |
