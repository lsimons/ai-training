...
<Choice id="what-the-model-does" objective="concepts/explains-models/explains-generation"
  ...
  options={[
    ...
    { text: 'It reasoned about the question first, then wrote the answer down.', why: 'There is no reasoning step separate from generation. Any reasoning happens as generated text, one token at a time.' },
  ]}>
